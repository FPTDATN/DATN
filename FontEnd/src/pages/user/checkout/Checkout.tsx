...
const stripePromise = loadStripe(
    'pk_test_51OCJujAEqVUq8VkznGyleauRrqdrGZXL3LqySMl85PEMeIofUFxOCb76tB1JGWBqlmt244Bl6CaN64SHTRE644dV00wwm0NaiQ',
);
...
const LocationList: React.FC = () => {
    ...
    useEffect(() => {
        if (payMethod === 1) {
            ...
            setMethodBody(
                <div className="mt-2">
                    <CheckoutNormal form={form} authData={authData!} cartItems={cartItems} payMethod={payMethod} />
                </div>,
            );
        }
    }, [payMethod]);
