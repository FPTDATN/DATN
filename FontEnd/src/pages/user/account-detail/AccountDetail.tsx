                            ...
                            <div className="row d-flex">
                                <div className="col-lg-4">
                                    <div className="card mb-4">
                                        <div className="card-body text-center items-center flex flex-wrap justify-center gap-x-4">
                                            <div className="flex justify-center flex-col flex-1 gap-y-2">
                                                <div className="flex justify-center">
                                                    <img
                                                        ...
                                                        alt="avatar"
                                                        className="rounded-circle  img-fluid w-[150px]"
                                                    />
                                                </div>
                                                <UploadAvatar/>
                                            </div>
                                            <div className="flex-1">
                                                <h5 className="my-3">{authData?.username}</h5>
                                    ...
                                    <div className="card mb-4 mb-lg-0">
                                        <div className="card-body p-0">
                                            <ul className="list-group list-group-flush rounded-3">
                                                <p className="mb-2 list-group-item d-flex justify-content-start align-items-center p-3">
                                                    Đơn hàng của bạn
                                                </p>
                                            ...
                                            <Link
                                                to={'#'}
                                                className="text-primary align-items-center font-italic me-1 p-2"
                                            >
                                                Xem thêm
                                            </Link>
                                        </div>
                                    ...
                                    <div className="row d-flex">
                                        <div className="col-md-5">
                                            <div className="card mb-4 mb-md-0">
                                                <div className="card-body ">
                                                    <p className="mb-4"> Sản phẩm yêu thích</p>
                                                    ...
                                                    <Link
                                                        to={'your-favorite'}
                                                        className="text-primary align-items-center font-italic me-1"
                                                    >
                                                        Xem thêm
                                                    </Link>
                                                </div>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <Link to={'#'}>
                                                        ...
                                                        <div className="bg-gray-100">
                                                            <img
                                                                src="https://onoff.vn/media/catalog/product/cache/ecd9e5267dd6c36af89d5c309a4716fc/W77TP20251.jpg "
                                                                className="w-[70px]"
                                                                alt="no images"
                                                            />
                                                        </div>
