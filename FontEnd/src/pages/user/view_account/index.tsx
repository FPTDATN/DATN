                    ...
                    <div className="pt-2">
                        ...
                        <div className="column relative z-10 justify-center flex-1 py-2 mx-auto lg:py-0">
                            <div className="col-lg-10 pb-5 my-5 rounded column">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 place-items-center align-items-center text-center mx-1 px-4 mb-6 h-[250px]">
                                    <div className="w-[150px] h-[200px] rounded mt-3 mr-4 col-span-1">
                                        <img
                                            src={
                                                authData?.avatar ||
                                            ...
                                            alt="avatar"
                                            className="rounded-circle p-1 bg-gray w-[150px] h-[150px]"
                                        />
                                    </div>
                                    <div className="mt-3 mb-3 col-span-2">
