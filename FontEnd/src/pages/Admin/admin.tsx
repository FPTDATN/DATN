 ...
 export const Admin = () => {
  return (
    <div className="font-poppins antialiased h-screen  flex">
      <div
        id="sidebar"
        className="bg-white w-60 md:w-60 lg:w-60 shadow-xl overflow-x-hidden transition-transform duration-300 ease-in-out"
      >
        <div
      id="view"
      className=""
    ...
    >
      ...
      <div className="  flex flex-grow justify-center w-full md:w-2/3 lg:w-3/4">
        {/* Nội dung chính (điều hướng) */}
        <Outlet />
      </div>
    </div>
  );
