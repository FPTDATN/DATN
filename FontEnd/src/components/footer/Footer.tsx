    ...
    return (
        <section className="flex flex-col lg:justify-end font-poppins">
            <div className="relative py-10 bg-center bg-no-repeat bg-cover"
                style={{ backgroundImage: "url('https://i.postimg.cc/DwppyZZP/mypic3.jpg')" }}>
                ...
                <div className="relative z-10 justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
                    <div className="flex flex-wrap pb-10 -mx-3">
                        <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                            <a href="#" className="inline-block pb-2 text-lg font-bold text-gray-300">About Company</a>
                        ...
                        <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                            ...
                            <ul>
                                ...
                                <li className="mb-4">
                                    <a href="#"
                                        className="inline-block text-base font-normal text-gray-400 dark:text-gray-400">Features</a>
                                </li>
                            </ul>
                        </div>
