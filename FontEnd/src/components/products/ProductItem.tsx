            ...
            {loading ? (
                ...
                <div className="border border-gray-200 rounded-md bg-gray-50 dark:border-gray-900 rounded-b-md dark:bg-gray-900">
                    ...
                    <div className="py-6">
                        ...
                        <p className="mb-3 text-lg font-medium text-center text-gray-600 dark:text-gray-400">
                            ...
                            {product?.sale_off! > 0 && (
                                <span className="ml-2 text-gray-400 line-through dark:text-gray-400 text-sm lg:text-xl">
                                    ${product?.price}
                                </span>
                            )}
                        </p>
                ...
                <div className="grid grid-cols-2 border border-gray-200 rounded-md bg-gray-50 dark:border-gray-900 rounded-b-md dark:bg-gray-900">
                    ...
                    <button
                        ...
                        className="flex w-full col-span-2 text-sm md:text-base lg:text-xl justify-center px-4 py-2 text-primary/90 border border-primary/90 items-center dark:border-gray-600 dark:text-gray-400 hover:bg-primary/90 hover:text-gray-100 dark:hover:bg-gray-800 dark:hover:border-gray-900"
                    >
                        Thêm vào giỏ hàng
                    </button>
                </div>
